            ...
            <div className="mx-auto max-w-md px-4 text-center sm:px-6 sm:max-w-3xl lg:px-8 lg:max-w-7xl">
              <div>
                ...
                <p className="mt-5 max-w-prose mx-auto text-xl text-gray-500">
                  Experience a seamless and secure betting environment powered
                  by blockchain technology. Our platform ensures the fairness
                  and transparency of all bets, providing you with a
                  cutting-edge betting experience.
                </p>
              </div>
            ...
            <div className="relative">
              <div className="text-center mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
                ...
                <p className="mt-5 mx-auto max-w-prose text-xl text-gray-500">
                  Expand your knowledge and enhance your betting skills with our
                  helpful resources.
                </p>
              </div>
